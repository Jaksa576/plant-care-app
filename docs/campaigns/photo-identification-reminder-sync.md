...
- The plant profile and dashboard use enabled reminder dates for visible urgency before falling back to interval-based watering calculations.
...
| Profile and dashboard reminders | Enabled reminder dates drive visible next watering, overdue, due today, and upcoming grouping |
...
- The profile and dashboard reflect app-owned watering reminders when enabled reminder dates exist.
