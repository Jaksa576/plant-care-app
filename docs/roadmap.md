...
- Internal care profile gap-first patch with 123 profiles, 407 aliases, stronger spider plant aliases, broader orchid starters, explicit corn plant/mass cane coverage, additional common-name profiles, regenerated seed SQL, and validated intentional ambiguity warnings.
- Internal care profile QA scientific-name patch with 123 profiles, 411 aliases, exact aliases for Chlorophytum capense and Phalaenopsis singuliflora variants, conservative scientific-name candidate matching, regenerated seed SQL, and targeted verification for spider plant, moth orchid, and corn plant misses.
...
- Internal care profile database with `care_profiles`, `care_profile_aliases`, species/genus/care-group/fallback levels, ambiguity-safe lookup, validated seed fixtures, generated seed SQL, and 123 reviewed practical profiles with 411 aliases.
